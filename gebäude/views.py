...
def details(request, id):
    ...
    return render(request, 'test_details.html', {'objekt': objekt, 'kosten': kosten, 'technik': technik, 'mietern': mietern, 'wohnungen': wohnungen, 'gesamtsumme_miete': gesamtsumme_miete, 'gesamtsumme_kaution': gesamtsumme_kaution, 'gesamtsumme_kosten':gesamtsumme_kosten, 'gewinn_verlust': gewinn_verlust})
...
def wohnung_details(request, id):
    ...
    return render(request, 'wohnung_details.html', {'mieter': mieter, 'technik': technik})